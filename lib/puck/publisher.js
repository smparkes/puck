  ...
  var Publisher = Puck.Publisher =
    new Puck.Class(function Publisher() {
      ...
      add_subscription: function add_subscription(callback, options) {
        ...
        // this.call_(record, this.puck_state);
      },
      ...
      notify: function notify(/*...*/) {
        this.puck_state_id = ( this.puck_state_id && this.puck_state_id+1 ) || 1;
        this.call_all_(arguments);
        this.puck_state = arguments;
      },
      ...
      call_: function call_(record, new_state) {
        if (record[1] !== this.puck_state_id) {
          if (false && record[1] && record[1] === this.puck_state_id-1) {
            record[1] = this.puck_state_id;
